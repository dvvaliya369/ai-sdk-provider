...
import { ActionEventPayload } from '@openrouter-monorepo/github-action-utils/action-event-payload';
import {
  GitHubActionsLayer,
  withActionsErrorReporting,
} from '@openrouter-monorepo/github-action-utils/action-ui';
...
const GitHubWithPayloadLayer = GitHubLive.pipe(Layer.provide(ActionEventPayload.Default));
...
const InputConfigProvider = ConfigProvider.nested(ConfigProvider.fromEnv(), 'INPUT');

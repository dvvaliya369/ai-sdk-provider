...
describe('toRelativePath', () => {
  ...
  it('converts absolute path to relative using GITHUB_WORKSPACE', () => {
  ...
  it('converts absolute path to relative using cwd when GITHUB_WORKSPACE not set', () => {
    delete process.env['GITHUB_WORKSPACE'];
  ...
  it('returns path unchanged when not under workspace', () => {
    process.env['GITHUB_WORKSPACE'] = '/home/runner/work/repo/repo';
  ...
  it('handles paths at the workspace root', () => {
    process.env['GITHUB_WORKSPACE'] = '/home/runner/work/repo/repo';
